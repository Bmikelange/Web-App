...
/**
 * Limits the access to the secretaries only.
 */
@WebFilter("/VerifAutorisationSecret")
public class VerifAutorisationSecret implements Filter {
